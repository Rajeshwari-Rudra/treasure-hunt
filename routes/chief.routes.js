/**
 * Route Chief requests to the correct controller function.
 *
 * A request includes:
...
const controller = require('../controllers/chiefController.js');

console.info('Starting chief routing.');
...
console.info('Loaded chief routes.');
