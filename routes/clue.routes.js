/**
 * Route clue requests to the correct controller function.
 *
 * A request includes:
...
const controller = require('../controllers/clueController.js');
const LOG = require('../util/logger');

LOG.info('Starting clue routing.');
