/**
 * Route competition requests to the correct controller function.
 *
 * A request includes:
 ...
 *
 * @author Puneeth Annam <s538293@nwmissouri.edu>
 */

const router = require('express').Router();
const controller = require('../controllers/competitionController.js');

console.info('Starting competition routing.');
...
console.info('Loaded competition routes.');
